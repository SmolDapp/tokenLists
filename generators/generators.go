...
const (
	...
	// GenerationStatic indicates that the list is generated by a static method
	GenerationStatic TGenerationMethods = "Static"
...
var GENERATORS = map[string]TGenerators{
	...
	`etherscan`: {
		...
		GeneratorType:    GeneratorToken,
		Exclude:          true,
		ExcludeReason:    `Cloudflare scraping protection`,
	},
	`filecoin`: {
